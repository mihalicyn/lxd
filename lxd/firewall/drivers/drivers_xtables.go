...
func (d Xtables) InstanceSetupNetPrio(projectName string, instanceName string, deviceName string, netPrio int) error {
	comment := fmt.Sprintf("LXD container %s netprio", project.Instance(projectName, instanceName))
